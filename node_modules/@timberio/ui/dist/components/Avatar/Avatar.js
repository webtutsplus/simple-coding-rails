...
var Placeholder = function Placeholder(_ref) {
  ...
  return _react.default.createElement(_Flex.default, placeholderStyle, query.charAt(0));
};
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          url = _this$props.url;
      return _react.default.createElement(Wrapper, this.props, _react.default.createElement(_Image.default, {
        size: size,
        query: email || url,
        provider: type,
...
cleaned.propTypes = Avatar.propTypes;
