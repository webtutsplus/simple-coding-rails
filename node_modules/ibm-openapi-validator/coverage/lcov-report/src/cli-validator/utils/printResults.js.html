...
<a name='L160'></a><a href='#L160'>160</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
...
&nbsp;
  ...
  if (
    reportingStats &amp;&amp;
    (stats.errors.total ||
<span class="branch-2 cbranch-no" title="branch not covered" >      stats.warnings.total </span>||
<span class="branch-3 cbranch-no" title="branch not covered" >      stats.infos.total </span>||
<span class="branch-4 cbranch-no" title="branch not covered" >      stats.hints.total)</span>
  ) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (stats.infos.total &gt; 0) {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
        chalk.cyan(`  Total number of infos    : ${stats.infos.total}`)
      );
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (stats.hints.total &gt; 0) {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
