...
<a name='L167'></a><a href='#L167'>167</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
&nbsp;
  Object.keys(semanticValidators).forEach(key =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (problem.infos.length) {
<span class="cstat-no" title="statement not covered" >      validationResults.infos[key] = [...problem.infos];</span>
<span class="cstat-no" title="statement not covered" >      validationResults.info = true;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (problem.hints.length) {
<span class="cstat-no" title="statement not covered" >      validationResults.hints[key] = [...problem.hints];</span>
<span class="cstat-no" title="statement not covered" >      validationResults.hint = true;</span>
    }
  });
&nbsp;
