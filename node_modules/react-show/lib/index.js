...
var _class, _temp; /* eslint-disable no-restricted-syntax, react/forbid-prop-types */
...
var ReactShow = (_temp = _class = function (_React$Component) {
  ...
  return ReactShow;
}(_react2.default.Component), _class.easings = easings, _class.defaultProps = {
  show: false,
  easing: 'easeOutQuad',
  duration: 300,
...
ReactShow.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  styleHide: _propTypes2.default.object,
  styleShow: _propTypes2.default.object,
